...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [ER_END] = COMBO(er_combo, KC_END),
  [SD_PAGEUP] = COMBO(sd_combo, KC_PGUP),
  [DF_PAGEDOWN] = COMBO(df_combo, KC_PGDOWN),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_WIN] = LAYOUT_ergodox_pretty(
    ...
    LCTL(KC_F7),    KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_KANA2,                                       KC_F7,          KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_EQUAL,
    ...
    KC_LGUI,        KC_TRANSPARENT, KC_TRANSPARENT, KC_LALT,        KC_F13,                                                                                                         KC_F14,         KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,
                                                                                                    KC_TRANSPARENT, TG(_MOUSE),     KC_PAUSE,       KC_ESCAPE,
                                                                                                                    TG(_MAC),       KC_TRANSPARENT,
...
//,----------------+---------------+---------------+---------------+---------------+---------------+---------------,                               ,---------------+---------------+---------------+---------------+---------------+---------------+---------------,
    KC_LGUI,        KC_F13,         KC_KANA2,       KC_LALT,        NG_SHFTL,                                                                                                       NG_SHFTR,       KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,
//,----------------+---------------+---------------+---------------+---------------+---------------+---------------,                               ,---------------+---------------+---------------+---------------+---------------+---------------+---------------,
                                                                                                    KC_TRANSPARENT, TG(_MOUSE),     KC_PAUSE,       KC_ESCAPE,
//,----------------+---------------+---------------+---------------+---------------+---------------+---------------,                               ,---------------+---------------+---------------+---------------+---------------+---------------+---------------,
...
//,----------------+---------------+---------------+---------------+---------------+---------------+---------------,                               ,---------------+---------------+---------------+---------------+---------------+---------------+---------------,
    ...
    KC_TILD,        KC_EXLM,        KC_AT,          KC_HASH,        KC_LCBR,        KC_RCBR,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_7,           KC_KP_8,        KC_KP_9,        KC_KP_SLASH,    KC_F12,
    KC_PLUS,        KC_DLR,         KC_PERC,        KC_CIRC,        KC_LPRN,        KC_RPRN,                                                                        KC_TRANSPARENT, KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_ASTR,        KC_F13,
    KC_UNDS,        KC_AMPR,        KC_ASTR,        KC_QUES,        KC_LBRACKET,    KC_RBRACKET,    KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_KP_MINUS,    KC_F14,
