...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_WIN] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_ENTER,                                       KC_ESCAPE,      KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_EQUAL,
    KC_TRANSPARENT, KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_KANA2,                                       KC_F10,         KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_SCOLON,
    KC_LCTRL,       KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_MINUS,       RCTL_T(KC_QUOTE),
    KC_RSHIFT,      KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           TG(_SIGN),                                      TG(_NUMMOUSE),  KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RSHIFT,
    KC_LGUI,        KC_LBRACKET,    MO(_NUMMOUSE),  KC_LALT,        KC_F13,                                                                                                         KC_F14,         KC_BSLASH,      MO(_SIGN),      KC_RBRACKET,    KC_PAUSE,
                                                                                                    KC_ESCAPE,      RESET,          LGUI(LSFT(KC_S)),KC_BSPACE,
                                                                                                                    TO(_MAC),       LCTL(KC_F7),
  ...
  [_NUMMOUSE] = LAYOUT_ergodox_pretty(
    LALT(KC_F4),    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,
    LCTL(KC_W),     KC_HOME,        LALT(LSFT(KC_TAB)),KC_MS_UP,    LALT(KC_TAB),   KC_PGUP,        KC_NO,                                          KC_NO,          KC_NO,          KC_7,           KC_KP_8,        KC_KP_9,        KC_KP_SLASH,    KC_F12,
    KC_TRANSPARENT, KC_MS_BTN2,     KC_MS_LEFT,     KC_MS_BTN1,     KC_MS_RIGHT,    KC_PGDOWN,                                                                      KC_NO,          KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_ASTR,        KC_TRANSPARENT,
    KC_TRANSPARENT, KC_END,         LCTL(LSFT(KC_TAB)),KC_MS_DOWN,  LCTL(KC_TAB),   KC_NO,          KC_NO,                                          KC_TRANSPARENT, KC_NO,          KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_MINUS,       KC_TRANSPARENT,
    KC_NO,          KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_ACCEL2,                                                                                                   KC_KP_0,        KC_KP_DOT,      KC_COMMA,       KC_PLUS,        KC_NO,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_NO,          KC_TRANSPARENT,
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [_SIGN] = LAYOUT_ergodox_pretty(
    KC_GRAVE,       KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_NO,                                          KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT,
    KC_TILD,        KC_EXLM,        KC_AT,          KC_HASH,        KC_LCBR,        KC_RCBR,        KC_NO,                                          KC_TRANSPARENT, KC_NO,          KC_AUDIO_VOL_UP,DYN_REC_START1, DYN_REC_START2, KC_INSERT,      KC_TRANSPARENT,
    ...
    KC_TRANSPARENT, KC_AMPR,        KC_ASTR,        KC_QUES,        KC_LBRACKET,    KC_RBRACKET,    KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_AUDIO_MUTE,  DYN_REC_STOP,   KC_NO,          KC_SCROLLLOCK,  KC_TRANSPARENT,
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                                                                                          KC_NO,          KC_NO,          KC_TRANSPARENT, KC_NO,          KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_NO,          KC_TRANSPARENT,
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [_MAC] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_LALT,        KC_TRANSPARENT, KC_TRANSPARENT, KC_LGUI,        KC_LANG2,                                                                                                       KC_LANG1,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
