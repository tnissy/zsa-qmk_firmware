...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_WIN] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_TRANSPARENT,                                 KC_F6,          KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_KANA2,                                       KC_F7,          KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_EQUAL,
    ...
    KC_LGUI,        KC_CAPSLOCK,    KC_TRANSPARENT, KC_LALT,        KC_F13,                                                                                                         KC_F14,         KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,
                                                                                                    KC_HOME,        TG(_MOUSE),     LGUI(LSFT(KC_S)),KC_END,
                                                                                                                    TG(_MAC),       LCTL(KC_F7),
